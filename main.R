...
source("src/get_one_efo_top_ensg_diff_exp_heatmap.R")
source("src/get_one_efo_top_ensg_diff_exp_heatmap_tbl.R")

source("src/get_one_ensg_all_efo_diff_exp_tbl.R")
source("src/get_one_ensg_all_efo_diff_exp_heatmap.R")
